...
const BOARD_HEIGHT = BUFFER_ROWS + VISIBLE_ROWS;
...
class GameScene extends Phaser.Scene {
  ...
  async create() {
    ...
    for (let i = GUTTER_WIDTH; i < GUTTER_WIDTH + TOWER_WIDTH; i++) {
      this.board[BOARD_HEIGHT - 1][i] = 1;
      const block = this.add.image(i * GRID_SIZE, (BOARD_HEIGHT - 1) * GRID_SIZE, "block").setOrigin(0);
